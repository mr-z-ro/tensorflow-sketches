...
IMAGE_HEIGHT = 440
IMAGE_WIDTH = 318
NOISE_RATIO = 0.0 # (was 0.6) percentage of weight of the noise for intermixing with the content image

CONTENT_WEIGHT = 0.01 # was 0.01
STYLE_WEIGHT = 1 # was 1

# Layers used for style features. You can change this.
# STYLE_LAYERS = ['conv1_1', 'conv2_1', 'conv3_1', 'conv4_1', 'conv5_1']
STYLE_LAYERS = ['conv3_1', 'conv3_2', 'conv4_1', 'conv5_1', 'conv5_2']
# W = [0.5, 1.0, 1.5, 3.0, 4.0] # give more weights to deeper layers.
W = [1.0, 2.0, 4.5, 6.5, 10.5]

# Layer used for content features. You can change this.
CONTENT_LAYER = 'conv4_2' # was conv4_2
